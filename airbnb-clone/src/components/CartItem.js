...
export const CartItem = ({item, handleDelete, selectedItemId, handleSelection}) => {
    ...
    return (
        <div className="d-flex justify-content-between align-items-center mt-3 p-2 items rounded flex-wrap bg-light">
            ...
            <div className="d-flex flex-row align-items-center flex-1 justify-content-end">
                ...
                <button className="btn-sm btn-outline-light ml-2 remove-btn" onClick={() => handleDelete(item.id)}>
